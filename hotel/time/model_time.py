...
class GAN:
    ...
    def build_model(self):
        ...
        real_labels=  tf.placeholder('float32', [self.options['batch_size'], 1],name='real_labels')
       ...
       # d_loss4= tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(logits=disc_real_bf_logits, labels=real_labels))
       # g_loss3 = tf.reduce_mean(tf.nn.sigmoid_cross_entropy_with_logits(logits=disc_fake_bf_logits, labels=real_labels))
